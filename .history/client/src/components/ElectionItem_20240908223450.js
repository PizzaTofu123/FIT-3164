...
const ElectionItem = ({ clubLogo, clubName, electionEndDate }) => {
  ...
  const isClosingSoon = () => {
    const closingDateObj = parseDate(electionEndDate);
  ...
  return (
    <div className="election-item">
      ...
      <p className={isClosingSoon() ? 'closing-soon' : ''}>
            {isClosingSoon() ? `Closing soon: ${electionEndDate}` : `Polling closes: ${electionEndDate}`}
          </p>
